...
export function CapabilityGrid({ stats, loading }: CapabilityGridProps) {
  const cards = [
    ...
    },
    {
      ...
      href: "/library",
      icon: Database,
      tileStyle: "bg-[#d1d5db] text-[#111827] border-slate-300 hover:bg-[#e5e7eb] hover:border-slate-400",
      badge: stats ? `${stats.verifiedEvidenceCount} Verified` : "Evidence Bank",
      badgeStyle: "bg-slate-300/80 text-slate-900 border-slate-400 font-bold",
