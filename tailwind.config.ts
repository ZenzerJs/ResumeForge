  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "page-title-mobile": ["32px", { lineHeight: "1.2", letterSpacing: "-0.02em", fontWeight: "800" }],
        "heading-xl": ["28px", { lineHeight: "1.3", letterSpacing: "-0.02em", fontWeight: "700" }],
        "heading-lg": ["22px", { lineHeight: "1.3", letterSpacing: "-0.01em", fontWeight: "700" }],
